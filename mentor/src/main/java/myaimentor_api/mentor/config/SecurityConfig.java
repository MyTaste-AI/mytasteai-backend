...
import myaimentor_api.mentor.auth.JwtAuthenticationFilter;
import myaimentor_api.mentor.auth.JwtProperties;
 ...
 * - /error 는 ResponseStatusException 시 내부 forward 되므로 명시적으로 permitAll
 */
@Configuration
@EnableWebSecurity
